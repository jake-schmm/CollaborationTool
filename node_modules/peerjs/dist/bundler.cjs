...
var $2QID2$cborxindexnoeval = require("cbor-x/index-no-eval");
...
class $0cb783f200ef4d91$export$7e9583c3c8a0a2cc extends (0, $544799118fa637e6$export$72aa44612e2200cd) {
    constructor(peerId, provider, options){
        ...
        this._encoder = new (0, $2QID2$cborxindexnoeval.Encoder)();
        this._decoder = new (0, $2QID2$cborxindexnoeval.Decoder)();
